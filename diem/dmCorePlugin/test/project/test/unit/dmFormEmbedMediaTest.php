...
$media1FullPath = _sys_get_temp_dir().'/'.$media1FileName;
...
$media2FullPath = _sys_get_temp_dir().'/'.$media2FileName;
...
$media3FullPath = _sys_get_temp_dir().'/'.dmString::random().$media3FileName;
