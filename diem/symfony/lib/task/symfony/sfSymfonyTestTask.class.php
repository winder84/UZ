...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    if ($files = glob(_sys_get_temp_dir().DIRECTORY_SEPARATOR.'/sf_autoload_unit_*'))
    {
    ...
    $status = false;
    $statusFile = _sys_get_temp_dir().DIRECTORY_SEPARATOR.sprintf('/.test_symfony_%s_status', md5(dirname(__FILE__)));
