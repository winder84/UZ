...
/**
 * Podrazdelenia filter form base class.
 *
 * @package    diem_uz
 * @subpackage filter
 ...
 */
abstract class BasePodrazdeleniaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('podrazdelenia_filters[%s]');
