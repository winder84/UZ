...
/**
 * Factorys form base class.
 *
 * @method Factorys getObject() Returns the current form's model object
 *
 * @package    diem_uz
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BaseFactorysForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('factorys[%s]');
