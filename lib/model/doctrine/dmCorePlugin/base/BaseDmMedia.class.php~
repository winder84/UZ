 ...
 * @property Doctrine_Collection $Factorys
 * @property Doctrine_Collection $Podrazdelenia
 * 
 ...
 * @method Doctrine_Collection getFactorys()           Returns the current record's "Factorys" collection
 * @method Doctrine_Collection getPodrazdelenia()      Returns the current record's "Podrazdelenia" collection
 ...
 * @method DmMedia             setNews()               Sets the current record's "News" collection
 * @method DmMedia             setFactorys()           Sets the current record's "Factorys" collection
 * @method DmMedia             setPodrazdelenia()      Sets the current record's "Podrazdelenia" collection
 * 
 * @package    diem_uz
 * @subpackage model
...
abstract class BaseDmMedia extends myDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Factorys', array(
             'local' => 'id',
             'foreign' => 'image'));

        $this->hasMany('Podrazdelenia', array(
             'local' => 'id',
             'foreign' => 'image'));
